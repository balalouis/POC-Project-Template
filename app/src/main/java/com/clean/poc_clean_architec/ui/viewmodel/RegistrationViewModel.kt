...
import com.clean.poc_clean_architec.data.model.RegistrationUiState
import com.clean.poc_clean_architec.domain.usecases.RegistrationUserUserCases
...
class RegistrationViewModel @Inject constructor(private var registrationUserUserCases: RegistrationUserUserCases) : ViewModel() {
    ...
    private var _uiState: MutableStateFlow<RegistrationUiState> = MutableStateFlow(RegistrationUiState.Success(
